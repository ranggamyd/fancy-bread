...
<head>
    ...
    <title>Fancy Cake & Bakery | Invoice {{ $purchase->invoice }}</title>
...
<body>
    <table class="w-full">
        <tr>
            ...
            <td class="w-half">
                <h2>Invoice : {{ $purchase->invoice }}</h2>
            </td>
        </tr>
    </table>
                    ...
                    <table>
                        ...
                        <tr>
                            <td style="text-align: center;">
                                <h4>{{ $purchase->vendor->name }}</h4>
                            </td>
                            <td></td>
                            <td>{{ $purchase->vendor->short_address }}</td>
                        </tr>
                        <tr>
                            <td colspan="3">{{ $purchase->vendor->full_address }}</td>
                        </tr>
                    </table>
                </td>
            </tr>
        ...
        <table class="products">
            ...
            <tfoot>
                ...
                <tr>
                    ...
                    <th colspan="2">{{ $purchase->total_items }}</th>
                    @if($item->discount)
                    <th>Rp.</th>
                    <th style="text-align: right;">{{ number_format($purchase->total_discount, 2, ',', '.') }}</th>
                    @else
                ...
                <tr>
                    ...
                    <th>Rp.</th>
                    <th style="text-align: right;">{{ number_format($purchase->shipping_price, 2, ',', '.') }}</th>
                </tr>
                <tr>
                    <th colspan="6" style="background-color: #fff;"></th>
                    <th style="text-align: left;">Grandtotal</th>
                    <th>Rp.</th>
                    <th style="text-align: right;">{{ number_format($purchase->grandtotal, 2, ',', '.') }}</th>
                </tr>
            </tfoot>
        </table>
    </div>
